...
public class CakeHomeListAdapter extends RecyclerView.Adapter<CakeHomeListAdapter.MyViewHolder> {
    ...
    public CakeHomeListAdapter(Context context, NewOrderList newOrderList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.restName.setText(newOrderList.getOrder().getCake().get(position).getCakeStore().getName());
        String date = newOrderList.getOrder().getCake().get(position).getCakeStore().getDate();
    ...
    public int getItemCount() {
        return newOrderList.getOrder().getCake().size();
    }
