...
import com.geekhive.foodeydeliveryboy.adapters.GroceryOrderListAdapter;
    ...
    public void onResponse(Object response, WebServices.ApiType apiType, boolean isSucces) {
        if (apiType == WebServices.ApiType.orderHistory) {
            if (!isSucces) {
                ...
                GrocOrderHistory orderHistory = (GrocOrderHistory) response;
                if (orderHistory != null){
                    if (orderHistory.getOrderHistory() != null){
                        GroceryOrderListAdapter customAdapter = new GroceryOrderListAdapter(getActivity(), orderHistory);
