...
public class CakeOrderCompletedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        go_to_feed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CakeOrderCompletedActivity.this, MainActivity.class));
                CakeOrderCompletedActivity.this.finish();
            }
        });
