...
public class CakesPickOrderActivity extends AppCompatActivity implements OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickup.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                CallPickedService(orderListOut.getOrderHistory().get(position_).getCakeCart().getId());
            }
        });
    ...
    private void CallPickedService(String cart_id) {
        if (this.mDetector.isConnectingToInternet()) {
            new WebServices(this).OrderCakePicked(WebServices.Foodey_Services,
        ...
        if (apiType == WebServices.ApiType.restaurantList) {
            if (!isSucces) {
                ...
                if (!isSucces || orderListOut == null) {
                    ...
                    String confTest ="Confirm " + orderListOut.getOrderHistory().get(position_).getCakeCartDetail().size() + " items";
            ...
            if (!isSucces || orderPicked == null) {
                ...
                Intent intent = new Intent(CakesPickOrderActivity.this, CakeReachDropLocation.class);
    ...
    public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            String items = orderListOut.getOrderHistory().get(position_).getCakeCartDetail().get(position).getCake().getProductName() + " * " + orderListOut.getOrderHistory().get(position_).getCakeCartDetail().get(position).getQuantity();
        ...
        public int getItemCount() {
            return orderListOut.getOrderHistory().get(position_).getCakeCartDetail().size();
        }
