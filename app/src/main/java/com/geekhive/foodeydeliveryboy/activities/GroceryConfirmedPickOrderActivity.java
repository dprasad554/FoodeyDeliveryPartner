...
public class GroceryConfirmedPickOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picked_order.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent=new Intent(GroceryConfirmedPickOrderActivity.this,ReachDropLocation.class);
