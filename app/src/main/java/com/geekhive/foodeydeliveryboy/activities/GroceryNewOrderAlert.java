...
public class GroceryNewOrderAlert extends AppCompatActivity implements OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slide_to_accept.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                ...
                player.stop();
                CallOrderService(Prefs.getUserId(GroceryNewOrderAlert.this), orderListOut.getOrder().getGrocery().get(position_).getGCart().getId());
            }
        });
    ...
    public void onResponse(Object response, WebServices.ApiType apiType, boolean isSucces) {
        ...
        if (apiType == WebServices.ApiType.newOrderList) {
            ...
            if (!isSucces || orderConfirmation == null) {
                ...
                Intent intent=new Intent(GroceryNewOrderAlert.this, GroceryRestaurantReachActivity.class);
                ...
                GroceryNewOrderAlert.this.finish();
            }
        }
