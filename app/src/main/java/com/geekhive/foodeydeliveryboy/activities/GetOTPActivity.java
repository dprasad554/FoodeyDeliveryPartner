...
public class GetOTPActivity extends AppCompatActivity implements OnResponseListner {
    Button get_otp;
    Dialog OtpPopup;
                ...
                if (!isSucces || verifyOtp == null) {
                    ...
                    if (verifyOtp.getMessage() != null) {
                        if (!verifyOtp.getMessage().isEmpty()) {
                            ...
                            startService(intent);
                            Intent intenti = new Intent(GetOTPActivity.this, PickOrderActivity.class);
    ...
    private void InitializeConfirmOtppopup() {
        OtpPopup = new Dialog(GetOTPActivity.this);
