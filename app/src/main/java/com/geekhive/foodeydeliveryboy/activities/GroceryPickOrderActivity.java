...
public class GroceryPickOrderActivity extends AppCompatActivity implements OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickup.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                CallPickedService(orderListOut.getOrderHistory().get(position_).getGCart().getId());
            }
        });
    ...
    private void CallPickedService(String cart_id) {
        if (this.mDetector.isConnectingToInternet()) {
            new WebServices(this).GrocOrderPicked(WebServices.Foodey_Services,
        ...
        if (apiType == WebServices.ApiType.restaurantList) {
            if (!isSucces) {
                ...
                if (!isSucces || orderListOut == null) {
                    ...
                    String confTest ="Confirm " + orderListOut.getOrderHistory().get(position_).getGCartDetail().size() + " items";
            ...
            if (!isSucces || orderPicked == null) {
                ...
                Intent intent = new Intent(GroceryPickOrderActivity.this, GroceryReachDropLocation.class);
    ...
    public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            String items = orderListOut.getOrderHistory().get(position_).getGCartDetail().get(position).getGrocery().getProductName() + " * " + orderListOut.getOrderHistory().get(position_).getGCartDetail().get(position).getGrocery().getQuantity();
        ...
        public int getItemCount() {
            return orderListOut.getOrderHistory().get(position_).getGCartDetail().size();
        }
