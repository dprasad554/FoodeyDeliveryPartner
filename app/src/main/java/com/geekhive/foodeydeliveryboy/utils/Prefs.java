...
public class Prefs {
    ...
    static final String PREF_OPEN_CLOSE = "open_close";
    static final String PREF_BIKENO = "bikeno";
    static final String PREF_CITYID = "city_id";
    ...
    public static void setCityId(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_CITYID, s).commit();
    }

    public static String getCityId(Context ctx) {
        return getPrefs(ctx).getString(PREF_CITYID, "");
    }
    ...
    public static void setOpenClose(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_OPEN_CLOSE, s).commit();
    }


    public static String getOpenClose(Context ctx) {
        return getPrefs(ctx).getString(PREF_OPEN_CLOSE, "");
    }
    ...
    public static void setBikeNo(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_BIKENO, s).commit();
    }

    public static String getBikeNo(Context ctx) {
        return getPrefs(ctx).getString(PREF_BIKENO, "");
    }
